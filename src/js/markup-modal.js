...
modalWind.insertAdjacentHTML("beforeend", modalMarkup);
...
function createModalMarkup(modal) {
    ...
    <div class="section_wind">
        ...
        <button class="modal_btn_l modal_btn" type="button">add to Watched</button>
        <button class="modal_btn_r modal_btn" type="button">add to queue</button>
    </div>`;
    }).join("");
}